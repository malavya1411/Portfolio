...
type LimelightNavProps = {
  ...
  activeIndex?: number; // Added to support controlled state (scrolling sync)
...
export const LimelightNav = ({
  ...
  return (
    <nav className={`relative inline-flex items-center h-16 ${className ? className : 'rounded-lg bg-card text-foreground border px-2'}`}>
