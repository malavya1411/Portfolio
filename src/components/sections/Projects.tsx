...
function ProjectThumbnail({ slug }: { slug: string }) {
  if (slug === "git-stat") {
    return (
      <div className="w-full h-full bg-[#0f172a] text-[#34d399] p-4 flex flex-col justify-between font-mono select-none overflow-hidden relative">
        ...
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-800 pb-2 text-[10px] text-slate-400 z-10">
          <div className="flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-[#ef4444]" />
            <span className="w-2 h-2 rounded-full bg-[#eab308]" />
            <span className="w-2 h-2 rounded-full bg-[#22c55e]" />
            <span className="ml-1 font-mono text-[9px] text-slate-300">gitstat-dashboard</span>
          </div>
          <span className="text-emerald-400 font-semibold tracking-wider text-[8px] bg-emerald-500/10 px-1.5 py-0.5 rounded">LIVE</span>
        </div>
        {/* Dashboard Preview */}
        <div className="flex-1 flex flex-col justify-center gap-3 py-2 z-10">
        ...
        {/* Metrics Footer */}
        <div className="flex justify-between items-center text-[9px] text-slate-500 border-t border-slate-800 pt-1.5 z-10">
  ...
  if (slug === "ai-finder") {
    return (
      <div className="w-full h-full bg-[#1a1a2e] text-slate-300 p-4 flex flex-col justify-between select-none overflow-hidden relative">
        {/* Grid background */}
        ...
        {/* Top Header */}
        <div className="flex items-center justify-between text-[9px] uppercase tracking-wider text-indigo-400 font-bold z-10">
          <span>AI AGENT DIRECTORY</span>
          <span className="bg-indigo-500/10 px-2 py-0.5 rounded text-[8px]">80+ Tools</span>
        </div>
        {/* Grid of Tool Cards */}
        <div className="flex-1 flex flex-col justify-center gap-2 z-10">
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-[#16162a]/80 border border-slate-800 p-2 rounded-lg flex items-center gap-1.5">
              <span className="w-4 h-4 rounded bg-indigo-500 flex items-center justify-center text-[8px] font-bold text-white shrink-0">M</span>
              <div className="flex flex-col min-w-0">
                <span className="text-[9px] font-bold text-white truncate">Midjourney</span>
                <span className="text-[7px] text-slate-500 truncate">Image Gen</span>
              </div>
            </div>
            <div className="bg-[#16162a]/80 border border-slate-800 p-2 rounded-lg flex items-center gap-1.5">
              <span className="w-4 h-4 rounded bg-rose-500 flex items-center justify-center text-[8px] font-bold text-white shrink-0">J</span>
              <div className="flex flex-col min-w-0">
                <span className="text-[9px] font-bold text-white truncate">Jasper AI</span>
                <span className="text-[7px] text-slate-500 truncate">Copywriting</span>
              </div>
            </div>
            <div className="bg-[#16162a]/80 border border-slate-800 p-2 rounded-lg flex items-center gap-1.5">
              <span className="w-4 h-4 rounded bg-sky-500 flex items-center justify-center text-[8px] font-bold text-white shrink-0">C</span>
              <div className="flex flex-col min-w-0">
                <span className="text-[9px] font-bold text-white truncate">Copilot</span>
                <span className="text-[7px] text-slate-500 truncate">Developer</span>
              </div>
            </div>
            <div className="bg-[#16162a]/80 border border-slate-800 p-2 rounded-lg flex items-center gap-1.5">
              <span className="w-4 h-4 rounded bg-amber-500 flex items-center justify-center text-[8px] font-bold text-white shrink-0">G</span>
              <div className="flex flex-col min-w-0">
                <span className="text-[9px] font-bold text-white truncate">Gemini</span>
                <span className="text-[7px] text-slate-500 truncate">Chatbot</span>
              </div>
            </div>
          </div>
        </div>
        <div className="text-[8px] text-slate-500 text-center font-mono uppercase tracking-widest border-t border-slate-800/50 pt-1.5 z-10">
  ...
  if (slug === "jr-06") { // Inventory Management
    return (
      <div className="w-full h-full bg-[#f8fafc] text-slate-800 p-4 flex flex-col justify-between select-none overflow-hidden relative border-b border-slate-100">
        {/* Subtle grid */}
        ...
        {/* Title */}
        <div className="flex items-center justify-between text-[9px] uppercase tracking-wider text-slate-400 font-semibold z-10">
          <span>INVENTORY CONTROL</span>
          <span className="text-emerald-500 font-bold">STATUS: OK</span>
        </div>
        {/* Chart / Graphs */}
        <div className="flex-1 flex items-end gap-2.5 py-3 px-1 z-10">
          {/* Bar Chart Mock */}
          ...
          <div className="w-16 h-full flex flex-col justify-center gap-1 border-l border-slate-200 pl-2 shrink-0">
            <div className="text-[7px] text-slate-400 leading-none">TOTAL ITEMS</div>
            <div className="text-xs font-bold text-slate-700 leading-none">1,248</div>
        ...
        {/* Footer */}
        <div className="text-[8px] text-slate-400 border-t border-slate-100 pt-1.5 flex justify-between font-mono z-10">
  ...
  if (slug === "ai-messaging") {
    return (
      <div className="w-full h-full bg-gradient-to-br from-[#dbeafe] to-[#eff6ff] text-slate-800 p-4 flex flex-col justify-between select-none overflow-hidden relative">
        {/* Phone mockups overlay */}
        <div className="absolute inset-0 flex justify-end items-end p-2 opacity-95">
          {/* Phone mockup */}
          <div className="w-[85px] h-[130px] bg-slate-900 rounded-t-xl border-x-2 border-t-2 border-slate-800 p-1 shadow-2xl flex flex-col gap-1 translate-y-3">
            <div className="w-6 h-1 bg-slate-800 mx-auto rounded-full" />
            <div className="flex-1 bg-white rounded-t-lg p-1 flex flex-col gap-1 overflow-hidden">
              <div className="bg-blue-100 text-[6px] text-blue-800 p-1 rounded-md max-w-[85%] self-end">
                Yes, that sounds perfect!
              </div>
              <div className="bg-slate-100 text-[6px] text-slate-700 p-1 rounded-md max-w-[85%]">
                Crafting message...
              </div>
              <div className="bg-blue-500 text-[6px] text-white p-1 rounded-md max-w-[80%] self-end font-semibold">
                Perfect messaging.
              </div>
            </div>
          </div>
        ...
        {/* Text Details */}
        <div className="z-10 max-w-[65%] flex flex-col gap-1">
        ...
        <div className="z-10 text-[8px] text-blue-500 font-mono">
          GEMINI API POWERED
        </div>
      </div>
    );
  ...
  if (slug === "boldbot") {
    return (
      <div className="w-full h-full bg-white text-slate-800 p-4 flex flex-col justify-between select-none overflow-hidden relative">
        ...
        {/* Header */}
        <div className="z-10 flex items-center justify-between text-[9px] uppercase tracking-wider text-indigo-600 font-bold">
          <span>BOLDBOT SLACK</span>
          <span className="text-slate-400">v1.2.0</span>
        </div>
        {/* Text */}
        <div className="z-10 flex flex-col gap-1 max-w-[90%]">
          <div className="text-[13px] font-black text-slate-900 leading-tight tracking-tight uppercase">
            BOLDBOT AUTOMATION
          </div>
          <div className="text-[9px] font-medium text-slate-500 leading-snug">
            "Automate your business, the bold way."
          </div>
        </div>
        {/* Footer */}
        <div className="z-10 text-[8px] text-indigo-500 font-mono tracking-wider">
  ...
  if (slug === "hiremind") {
    return (
      <div className="w-full h-full bg-[#0a0f1d] text-slate-300 p-4 flex flex-col justify-between font-sans select-none overflow-hidden relative">
        ...
        <div className="flex-1 flex flex-col justify-center gap-1.5 z-10">
          ...
          <div className="bg-[#111827]/95 border border-slate-800 p-2 rounded-lg flex items-center justify-between gap-1">
            <div className="flex items-center gap-2">
              <span className="w-5 h-5 rounded-full bg-indigo-500/20 text-indigo-400 flex items-center justify-center text-[9px] font-bold">JD</span>
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-white leading-none">John Doe</span>
                <span className="text-[8px] text-slate-500">React Developer</span>
              </div>
            </div>
            <span className="text-[9px] font-bold text-emerald-400">92% Match</span>
          </div>
        </div>
        <div className="text-[8px] text-slate-500 text-center font-mono border-t border-slate-800 pt-1.5 uppercase tracking-wider z-10">
  ...
  if (slug === "onboard-ai") {
    return (
      <div className="w-full h-full bg-[#1e1e1e] text-slate-300 p-4 flex flex-col justify-between font-mono select-none overflow-hidden relative">
        <div className="flex items-center justify-between border-b border-zinc-800 pb-1.5 text-[9px] text-zinc-500 z-10">
          <span>onboard-agent.sh</span>
          <span className="text-amber-500">RAG PROCESS</span>
        </div>
        <div className="flex-1 flex flex-col justify-center gap-1 z-10 text-[9px] leading-tight">
        ...
        <div className="text-[8px] text-zinc-600 border-t border-zinc-800 pt-1.5 text-right z-10">
          SLACK CLIENT ACTIVE
        </div>
      </div>
    );
  ...
  if (slug === "crisis-sync") {
    return (
      <div className="w-full h-full bg-[#f1f5f9] text-slate-800 p-4 flex flex-col justify-between select-none overflow-hidden relative">
        {/* Mock Map View */}
        ...
        {/* Texts */}
        <div className="z-10 flex items-center justify-between text-[9px] uppercase tracking-wider text-slate-400 font-bold">
        ...
        <div className="z-10 max-w-[65%] mt-auto">
          ...
          <span className="text-[8px] text-slate-500 font-mono">MAPS SDK & GEMINI AI</span>
        </div>
      </div>
    );
  }
