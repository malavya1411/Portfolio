...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "ai-messaging",
    summary: "Transform your thoughts into effective messages.",
    role: "Solo Developer",
    context: "Personal Project",
    techStack: ["React", "Tailwind CSS", "Gemini API"],
    outcome: "An intelligent messaging companion that crafts, rewrites, and refines chat messages based on tone and intent.",
    tags: ["AI", "Messaging", "Productivity"],
    github: "https://github.com/malavya1411/ai-messaging",
    demo: "https://ai-messaging.vercel.app",
    badge: "New",
    featured: true,
    year: "2026",
    coverImage: "/images/ai_messaging.png",
    status: "COMPLETED",
    categoryTag: "AI TOOL · REACT",
    dateString: "FEBRUARY 2026 · PERSONAL PROJECT",
  },
  {
    title: "BOLDBot",
    slug: "boldbot",
    summary: "Automate your business, the bold way.",
    role: "Lead Developer",
    context: "Freelance / Business Project",
    techStack: ["Node.js", "Express", "Slack API", "Stripe"],
    outcome: "A customizable automation bot built to integrate business operations, customer support, and payment alerts.",
    tags: ["Automation", "Slack", "SaaS"],
    github: "https://github.com/malavya1411/boldbot",
    demo: null,
    badge: null,
    featured: true,
    year: "2026",
    coverImage: "/images/boldbot.png",
    status: "COMPLETED",
